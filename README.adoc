...
a|
link:00._Course_Material/01._Assignments/08._Documentation_Client-to-client/08a._Document_A_Database.md[08a Document A Database]

link:00._Course_Material/01._Assignments/08._Documentation_Client-to-client/08b._Migrate_From_One_Database_To_Another.md[08b Migrate From One Database To Another]

link:00._Course_Material/01._Assignments/08._Documentation_Client-to-client/08c._WebRTC_Example.md[08c WebRTC Example]

link:00._Course_Material/01._Assignments/08._Documentation_Client-to-client/08d._Generate_Code_Documentation_For_DLS.md[08d <DLS Group> Create Code Documentation for DLS]
...
| 10. Databases (Documentation / Migration) / Media
| April 3rd
a|
* Backing up MySQL
* Documenting MySQL
...
//todo auth integration in week 08
